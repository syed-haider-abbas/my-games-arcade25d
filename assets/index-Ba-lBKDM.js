import{P as W,f as St,c as Dl,p as Qt,u as Oo,r as xt,j as k,B as Fn,V as Il}from"./index-BxtyFagU.js";var $n=(i=>(i.IDLE="IDLE",i.PLAYING="PLAYING",i.WON="WON",i))($n||{});const Ll=15,be=40,wi=14,Ca=250,Nl={2:[W.ONE,W.THREE],3:[W.ONE,W.TWO,W.THREE],4:[W.ONE,W.TWO,W.THREE,W.FOUR]},Ul={STANDARD:{name:"Classic",boardBg:16777215,safeStar:13358561,gridStroke:14870768,players:{[W.ONE]:{main:3900150,light:14412542,label:"Blue"},[W.TWO]:{main:15680580,light:16704226,label:"Red"},[W.THREE]:{main:1096065,light:13761253,label:"Green"},[W.FOUR]:{main:15381256,light:16710083,label:"Yellow"}}},KIDS:{name:"Kiddo",boardBg:16642808,safeStar:16502760,gridStroke:16574451,players:{[W.ONE]:{main:6514417,light:14739455,label:"Indigo"},[W.TWO]:{main:16007006,light:16770278,label:"Rose"},[W.THREE]:{main:1357990,light:13433841,label:"Teal"},[W.FOUR]:{main:16096779,light:16708551,label:"Amber"}}}},br=[{id:"zoo",name:"Zoo Party",icons:{[W.ONE]:St("🐧"),[W.TWO]:St("🦊"),[W.THREE]:St("🐸"),[W.FOUR]:St("🦁")}},{id:"pets",name:"Pet Pals",icons:{[W.ONE]:St("🐦"),[W.TWO]:St("🐱"),[W.THREE]:St("🐢"),[W.FOUR]:St("🐶")}},{id:"wild",name:"Wild Ones",icons:{[W.ONE]:St("🐳"),[W.TWO]:St("🐼"),[W.THREE]:St("🐊"),[W.FOUR]:St("🦒")}}],Pr=[{x:6,y:13},{x:6,y:12},{x:6,y:11},{x:6,y:10},{x:6,y:9},{x:5,y:8},{x:4,y:8},{x:3,y:8},{x:2,y:8},{x:1,y:8},{x:0,y:8},{x:0,y:7},{x:0,y:6},{x:1,y:6},{x:2,y:6},{x:3,y:6},{x:4,y:6},{x:5,y:6},{x:6,y:5},{x:6,y:4},{x:6,y:3},{x:6,y:2},{x:6,y:1},{x:6,y:0},{x:7,y:0},{x:8,y:0},{x:8,y:1},{x:8,y:2},{x:8,y:3},{x:8,y:4},{x:8,y:5},{x:9,y:6},{x:10,y:6},{x:11,y:6},{x:12,y:6},{x:13,y:6},{x:14,y:6},{x:14,y:7},{x:14,y:8},{x:13,y:8},{x:12,y:8},{x:11,y:8},{x:10,y:8},{x:9,y:8},{x:8,y:9},{x:8,y:10},{x:8,y:11},{x:8,y:12},{x:8,y:13},{x:8,y:14},{x:7,y:14},{x:6,y:14}],xr={[W.ONE]:[{x:7,y:13},{x:7,y:12},{x:7,y:11},{x:7,y:10},{x:7,y:9},{x:7,y:8}],[W.TWO]:[{x:1,y:7},{x:2,y:7},{x:3,y:7},{x:4,y:7},{x:5,y:7},{x:6,y:7}],[W.THREE]:[{x:7,y:1},{x:7,y:2},{x:7,y:3},{x:7,y:4},{x:7,y:5},{x:7,y:6}],[W.FOUR]:[{x:13,y:7},{x:12,y:7},{x:11,y:7},{x:10,y:7},{x:9,y:7},{x:8,y:7}]},Ar={[W.ONE]:0,[W.TWO]:13,[W.THREE]:26,[W.FOUR]:39},Fl={[W.ONE]:[{x:1,y:10},{x:4,y:10},{x:1,y:13},{x:4,y:13}],[W.TWO]:[{x:1,y:1},{x:4,y:1},{x:1,y:4},{x:4,y:4}],[W.THREE]:[{x:10,y:1},{x:13,y:1},{x:10,y:4},{x:13,y:4}],[W.FOUR]:[{x:10,y:10},{x:13,y:10},{x:10,y:13},{x:13,y:13}]},Ol=Pr.length,Bl=(i,e,t)=>{if(e===-1)return Fl[i][t];if(e===99){const o=(t-.5)*.4;return{x:7+o,y:7+o}}if(e>=52){const s=e-52;return xr[i]&&xr[i][s]?xr[i][s]:{x:7,y:7}}const n=Ar[i],r=(e+n)%Ol;return Pr[r]||{x:0,y:0}},Bo=(i,e)=>i.position===-1?e===6:!(i.position+e>57),zl=Pr.length,Pa=(i,e)=>(i+Ar[e])%zl,kl=(i,e,t)=>{const n=i.filter(a=>a.playerId===t&&Bo(a,e));if(n.length===0)return null;if(n.length===1)return n[0].id;let r=n[0],s=-1/0;return n.forEach(a=>{let o=0;const l=a.position,c=l===-1?0:l+e;if(l===-1&&(o+=100),c<52){const h=Pa(c,t);i.find(f=>f.playerId!==t&&f.position!==-1&&f.position<52&&Pa(f.position,f.playerId)===h)&&([0,8,13,21,26,34,39,47].includes(h)||(o+=200))}c===99&&(o+=150),l<52&&c>=52&&(o+=50),o+=c,o+=Math.random()*5,o>s&&(s=o,r=a)}),r.id},zo="little-ludo-state-v4",ko=[{id:"p1-0",playerId:W.ONE,position:-1},{id:"p1-1",playerId:W.ONE,position:-1},{id:"p1-2",playerId:W.ONE,position:-1},{id:"p1-3",playerId:W.ONE,position:-1},{id:"p2-0",playerId:W.TWO,position:-1},{id:"p2-1",playerId:W.TWO,position:-1},{id:"p2-2",playerId:W.TWO,position:-1},{id:"p2-3",playerId:W.TWO,position:-1},{id:"p3-0",playerId:W.THREE,position:-1},{id:"p3-1",playerId:W.THREE,position:-1},{id:"p3-2",playerId:W.THREE,position:-1},{id:"p3-3",playerId:W.THREE,position:-1},{id:"p4-0",playerId:W.FOUR,position:-1},{id:"p4-1",playerId:W.FOUR,position:-1},{id:"p4-2",playerId:W.FOUR,position:-1},{id:"p4-3",playerId:W.FOUR,position:-1}],mn=()=>Math.floor(Math.random()*9)+7,Da=()=>{let i={};if(typeof window<"u")try{const e=localStorage.getItem(zo);e&&(i=JSON.parse(e))}catch{}return{turn:W.ONE,diceValue:null,tokens:JSON.parse(JSON.stringify(ko)),winner:null,gameMode:"PVP",difficulty:"EASY",themeId:"KIDS",characterSetId:br[0].id,playerCount:2,activePlayers:[W.ONE,W.THREE],humanPlayers:[W.ONE,W.THREE],isRolling:!1,canRoll:!0,isMovingToken:!1,isBotThinking:!1,highlightedTokens:[],rollsWithoutSix:{[W.ONE]:0,[W.TWO]:0,[W.THREE]:0,[W.FOUR]:0},pityThreshold:{[W.ONE]:mn(),[W.TWO]:mn(),[W.THREE]:mn(),[W.FOUR]:mn()},...i,status:$n.IDLE}},Ia=i=>{if(typeof window<"u"){const{themeId:e,characterSetId:t}=i;localStorage.setItem(zo,JSON.stringify({themeId:e,characterSetId:t}))}},Kn=Dl((i,e)=>({...Da(),startGame:t=>{Qt("start");const n=t.humanCount+t.botCount,r=Math.max(2,Math.min(4,n)),s=Nl[r],a=s.slice(0,t.humanCount),o=t.botCount>0?"PVB":"PVP",l=JSON.parse(JSON.stringify(ko));i({status:$n.PLAYING,gameMode:o,playerCount:r,difficulty:t.difficulty,activePlayers:s,humanPlayers:a,turn:s[0],tokens:l,winner:null,diceValue:null,canRoll:!0,isRolling:!1,isMovingToken:!1,isBotThinking:!1,highlightedTokens:[],rollsWithoutSix:{[W.ONE]:0,[W.TWO]:0,[W.THREE]:0,[W.FOUR]:0},pityThreshold:{[W.ONE]:mn(),[W.TWO]:mn(),[W.THREE]:mn(),[W.FOUR]:mn()}})},setTheme:t=>{Qt("click"),i({themeId:t}),Ia({...e(),themeId:t})},setCharacterSet:t=>{Qt("click"),i({characterSetId:t}),Ia({...e(),characterSetId:t})},resetGame:()=>{Qt("click"),i(Da())},rollDice:()=>{const{isRolling:t,canRoll:n,turn:r,tokens:s,rollsWithoutSix:a,pityThreshold:o,difficulty:l,isBotThinking:c}=e();!n||t||c||(i({isRolling:!0}),setTimeout(()=>{const h=s.some(E=>E.playerId===r&&E.position!==-1);let d;l==="EASY"&&!h&&a[r]+1>=o[r]?d=6:d=Math.floor(Math.random()*6)+1;const f={...a},m={...o};d===6?(f[r]=0,m[r]=mn()):h||(f[r]+=1);const _=s.filter(E=>E.playerId===r&&E.position!==99).filter(E=>Bo(E,d)).map(E=>E.id);i({isRolling:!1,diceValue:d,highlightedTokens:_,canRoll:!1,rollsWithoutSix:f,pityThreshold:m});const{humanPlayers:p}=e();!p.includes(r)?_.length>0?(i({isBotThinking:!0}),setTimeout(()=>{const E=kl(s,d,r);E?e().moveToken(E):Ki()},1e3)):setTimeout(()=>Ki(),1e3):_.length===0&&setTimeout(()=>Ki(),1e3)},1e3))},moveToken:async t=>{const{highlightedTokens:n,tokens:r,diceValue:s,turn:a,isMovingToken:o}=e();if(!n.includes(t)||!s||o)return;i({isMovingToken:!0,highlightedTokens:[],isBotThinking:!1});const l=r.findIndex(_=>_.id===t);if(l===-1)return;let c=r[l].position;if(c===-1){c=0;const _=[...e().tokens];_[l]={..._[l],position:0},i({tokens:_}),Qt("tap"),await new Promise(p=>setTimeout(p,Ca))}else for(let _=0;_<s;_++){await new Promise(u=>setTimeout(u,Ca)),c++;const p=[...e().tokens];p[l]={...p[l],position:c},i({tokens:p}),Qt("tap")}let h=!1,d=!1;if(c===57){const _=[...e().tokens];_[l]={..._[l],position:99},i({tokens:_}),Qt("win"),d=!0}else if(c<52){const _=Ar[a],p=(c+_)%52,u=[...e().tokens];let E=!1;u.forEach(b=>{if(b.playerId!==a&&b.position!==-1&&b.position!==99&&b.position<52){const y=Ar[b.playerId],A=(b.position+y)%52;p===A&&([0,8,13,21,26,34,39,47].includes(A)||(b.position=-1,E=!0))}}),E&&(i({tokens:u}),setTimeout(()=>Qt("drop"),100),h=!0)}if(e().tokens.filter(_=>_.playerId===a).every(_=>_.position===99))i({status:$n.WON,winner:a,isMovingToken:!1}),Qt("win");else if(s===6||h||d){i({diceValue:null,canRoll:!0,isMovingToken:!1,highlightedTokens:[]});const{humanPlayers:_}=e();_.includes(a)||setTimeout(()=>e().rollDice(),1e3)}else Ki()}})),Ki=()=>{const i=Kn.getState(),{activePlayers:e,turn:t,humanPlayers:n}=i,s=(e.indexOf(t)+1)%e.length,a=e[s];Kn.setState({turn:a,diceValue:null,canRoll:!0,isMovingToken:!1,highlightedTokens:[],isBotThinking:!1}),n.includes(a)||setTimeout(()=>Kn.getState().rollDice(),1e3)},Vl=1.5,Hl=1.5,vt=i=>"#"+i.toString(16).padStart(6,"0"),Gl=(i,e,t,n,r)=>{const[s,a,o,l]=r;return`
        ...
        Q ${i} ${e} ${i+s} ${e}
        Z
    `},Wl=()=>{const{tokens:i,highlightedTokens:e,moveToken:t,turn:n,themeId:r,characterSetId:s,activePlayers:a,humanPlayers:o}=Kn(),{enableTilt:l,players:c}=Oo(),h=Ll*be,d=Ul[r],f=xt.useMemo(()=>br.find(u=>u.id===s)||br[0],[s]),m=xt.useMemo(()=>{const u=[];u.push(k.jsx("rect",{x:0,y:0,width:h,height:h,fill:vt(d.boardBg)},"bg"));const E=(y,A,w,R)=>{const U=a.includes(y),v=U?vt(d.players[y].main):"#cbd5e1",M=U?vt(d.players[y].light):"#f1f5f9",P=U?.15:.05;let H=R;return U&&!o.includes(y)&&(H="Bot"),k.jsxs("g",{style:{opacity:U?1:.6},children:[k.jsx("rect",{x:A*be,y:w*be,width:6*be,height:6*be,fill:v,opacity:P}),k.jsx("rect",{x:(A+.5)*be,y:(w+.5)*be,width:5*be,height:5*be,fill:M,rx:20}),U&&k.jsx("text",{x:(A+3)*be,y:(w+3.2)*be,textAnchor:"middle",fill:"black",opacity:"0.1",fontWeight:"900",fontSize:"32",style:{textTransform:"uppercase"},children:H})]},`base-${y}`)};u.push(E(W.TWO,0,0,c[W.TWO].name)),u.push(E(W.THREE,9,0,c[W.THREE].name)),u.push(E(W.ONE,0,9,c[W.ONE].name)),u.push(E(W.FOUR,9,9,c[W.FOUR].name)),Pr.forEach((y,A)=>{let R=[0,8,13,21,26,34,39,47].includes(A)?vt(d.safeStar):"#ffffff";A===0&&(R=a.includes(W.ONE)?vt(d.players[W.ONE].light):R),A===13&&(R=a.includes(W.TWO)?vt(d.players[W.TWO].light):R),A===26&&(R=a.includes(W.THREE)?vt(d.players[W.THREE].light):R),A===39&&(R=a.includes(W.FOUR)?vt(d.players[W.FOUR].light):R),u.push(k.jsx("rect",{x:y.x*be,y:y.y*be,width:be,height:be,fill:R,stroke:vt(d.gridStroke),strokeWidth:1},`main-${A}`))});const b=y=>{a.includes(y)&&xr[y].forEach((A,w)=>{u.push(k.jsx("rect",{x:A.x*be,y:A.y*be,width:be,height:be,fill:vt(d.players[y].main),opacity:.3,stroke:vt(d.gridStroke)},`h-${y}-${w}`))})};return[W.ONE,W.TWO,W.THREE,W.FOUR].forEach(y=>b(y)),u.push(k.jsx("rect",{x:6*be,y:6*be,width:3*be,height:3*be,fill:"#f8fafc"},"center-bg")),u.push(k.jsx("polygon",{points:`${6*be},${9*be} ${9*be},${9*be} ${7.5*be},${7.5*be}`,fill:vt(d.players[W.ONE].main),opacity:a.includes(W.ONE)?1:.2},"c-p1")),u.push(k.jsx("polygon",{points:`${6*be},${6*be} ${6*be},${9*be} ${7.5*be},${7.5*be}`,fill:vt(d.players[W.TWO].main),opacity:a.includes(W.TWO)?1:.2},"c-p2")),u.push(k.jsx("polygon",{points:`${6*be},${6*be} ${9*be},${6*be} ${7.5*be},${7.5*be}`,fill:vt(d.players[W.THREE].main),opacity:a.includes(W.THREE)?1:.2},"c-p3")),u.push(k.jsx("polygon",{points:`${9*be},${6*be} ${9*be},${9*be} ${7.5*be},${7.5*be}`,fill:vt(d.players[W.FOUR].main),opacity:a.includes(W.FOUR)?1:.2},"c-p4")),u},[h,c,d,a,o]),x=u=>vt(d.players[u].main),_=[{id:W.TWO,label:d.players[W.TWO].label,x:0,y:0,w:2,h:1,color:d.players[W.TWO].main,radii:[0,8,24,8]},{id:W.THREE,label:d.players[W.THREE].label,x:13,y:0,w:2,h:1,color:d.players[W.THREE].main,radii:[8,0,8,24]},{id:W.FOUR,label:d.players[W.FOUR].label,x:13,y:14,w:2,h:1,color:d.players[W.FOUR].main,radii:[24,8,0,8]},{id:W.ONE,label:d.players[W.ONE].label,x:0,y:14,w:2,h:1,color:d.players[W.ONE].main,radii:[8,24,8,0]}].map(u=>{if(!a.includes(u.id))return null;const E=n===u.id,b=u.w*be,y=u.h*be,A=Gl(u.x*be,u.y*be,b,y,u.radii),w=u.x*be+b/2,R=u.y*be+y/2;return k.jsxs("g",{className:E?"marker-pulsating":"",style:{transformOrigin:`${w}px ${R}px`},children:[k.jsx("path",{d:A,fill:vt(u.color),stroke:"none",style:{filter:E?"drop-shadow(0 0 4px rgba(0,0,0,0.3))":"none"}}),k.jsx("text",{x:w,y:R+7,textAnchor:"middle",fill:"white",fontSize:"18",fontWeight:"900",style:{textShadow:"0px 1px 2px rgba(0,0,0,0.3)",textTransform:"uppercase"},children:u.label})]},`marker-${u.id}`)}),p=xt.useMemo(()=>{const u=i.filter(y=>a.includes(y.playerId)),E={};u.forEach(y=>{const A=parseInt(y.id.split("-")[1]),{x:w,y:R}=Bl(y.playerId,y.position,A),U=`${w.toFixed(3)},${R.toFixed(3)}`;E[U]||(E[U]=[]),E[U].push({token:y,x:w,y:R})});const b=[];return Object.values(E).forEach(y=>{y.sort((A,w)=>{const R=e.includes(A.token.id),U=e.includes(w.token.id);if(R&&!U)return 1;if(!R&&U)return-1;const v=A.token.playerId===n,M=w.token.playerId===n;return v&&!M?1:!v&&M?-1:A.token.id.localeCompare(w.token.id)}),y.forEach((A,w)=>{b.push({...A,stackIndex:w,isTop:w===y.length-1})})}),b},[i,e,n,a]);return k.jsxs("div",{className:"w-full h-full flex justify-center items-center",children:[k.jsx("style",{children:`
...
`)+`
`+u);const b=E+p+a,y=E+u+o,A=To(r,r.VERTEX_SHADER,b),w=To(r,r.FRAGMENT_SHADER,y);r.attachShader(_,A),r.attachShader(_,w),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function R(P){if(i.debug.checkShaderErrors){const H=r.getProgramInfoLog(_)||"",B=r.getShaderInfoLog(A)||"",N=r.getShaderInfoLog(w)||"",j=H.trim(),X=B.trim(),G=N.trim();let J=!0,de=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,_,A,w);else{const K=Ao(r,A,"vertex"),te=Ao(r,w,"fragment");Xe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
                        ...
                        `,children:k.jsx(Rm,{})}),k.jsx("span",{className:`text-5xl font-black w-12 text-center ${ee.text}`,children:te}),k.jsx("button",{onClick:()=>Ae(te+1),disabled:te>=Qe,className:`
                            w-14 h-14 flex items-center justify-center rounded-full 
                            bg-white dark:bg-slate-800 shadow-[0_4px_0_rgba(0,0,0,0.1)] active:shadow-none active:translate-y-1
                            ${te>=Qe?"opacity-30 cursor-not-allowed":"hover:scale-105 active:scale-95"}
                            ${ee.btnText} transition-all duration-200
                        `,children:k.jsx(wm,{})})]})]})};return i===$n.IDLE?k.jsxs("div",{className:"flex flex-col h-screen w-full bg-slate-50 dark:bg-[#0f172a] overflow-hidden relative transition-colors duration-500 text-slate-900 dark:text-white",children:[k.jsxs("div",{className:"absolute inset-0 pointer-events-none opacity-40",children:[k.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-400/20 dark:bg-blue-900/20 rounded-full blur-[100px]"}),k.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-green-400/20 dark:bg-green-900/20 rounded-full blur-[100px]"})]}),k.jsx("header",{className:"shrink-0 h-16 md:h-20 px-4 flex items-center justify-center bg-white/50 dark:bg-slate-900/50 backdrop-blur-md z-30 sticky top-0 border-b border-slate-200/50 dark:border-white/5",children:k.jsx(Fn,{variant:"icon",size:"sm",onClick:U,title:"Return to Menu",children:k.jsx(Fo,{})})}),k.jsx("div",{className:"flex-1 overflow-y-auto p-4 md:p-8 pb-24",children:k.jsxs("div",{className:"max-w-4xl mx-auto space-y-10 text-center relative z-20",children:[k.jsxs("div",{className:"space-y-4 animate-fade-in pt-4",children:[k.jsx("div",{className:`
                            ...
                            `,children:k.jsx("span",{className:"text-6xl font-emoji",children:o==="KIDS"?St("🐧"):St("🎲")})}),k.jsx("h1",{className:"text-5xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tighter drop-shadow-sm",children:"Little Ludo"}),k.jsx("div",{className:"flex justify-center mt-4",children:k.jsxs("div",{className:"bg-slate-200 dark:bg-slate-800 p-1.5 rounded-2xl inline-flex shadow-inner",children:[k.jsx("button",{onClick:()=>l("KIDS"),className:`
                                        ...
                                        `,children:"🐧 Kiddo"}),k.jsx("button",{onClick:()=>l("STANDARD"),className:`
                                            px-6 py-2.5 rounded-xl text-sm font-bold uppercase tracking-wider transition-all
                                        ...
                                        `,children:"🎲 Classic"})]})})]}),k.jsxs("div",{className:"max-w-4xl mx-auto space-y-8 animate-fade-in",style:{animationDelay:"100ms"},children:[k.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8",children:[k.jsxs("div",{className:"bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-700 space-y-4",children:[k.jsx("h2",{className:"text-sm font-bold uppercase tracking-widest text-slate-400 text-center",children:"Difficulty"}),k.jsxs("div",{className:"flex gap-3",children:[k.jsxs("button",{onClick:()=>A("EASY"),className:`
                                            ...
                                            `,children:[k.jsx("span",{className:"text-3xl",children:"😊"}),k.jsx("span",{children:"Easy"})]}),k.jsxs("button",{onClick:()=>A("NORMAL"),className:`
                                                flex-1 p-4 rounded-2xl font-bold transition-all border-4 flex flex-col items-center gap-1
                                            ...
                                            `,children:[k.jsx("span",{className:"text-3xl",children:"😎"}),k.jsx("span",{children:"Normal"})]})]}),k.jsx("p",{className:"text-xs text-slate-400 font-medium pt-2",children:y==="EASY"?"Forgiving rules & more 6s!":"Standard Ludo rules apply."})]}),k.jsxs("div",{className:"bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-700 space-y-4",children:[k.jsx("h2",{className:"text-sm font-bold uppercase tracking-widest text-slate-400 text-center",children:"Game Mode"}),k.jsx("div",{className:"grid grid-cols-3 gap-2",children:[{id:"FRIENDS",label:"Friends",icon:"👥",color:"pink"},{id:"BOTS",label:"Bots",icon:"🤖",color:"indigo"},{id:"CUSTOM",label:"Custom",icon:"🛠️",color:"amber"}].map(K=>{const te=x===K.id,Ae=K.color==="pink"?"text-pink-500":K.color==="indigo"?"text-indigo-500":"text-amber-500",Ce=K.color==="pink"?"border-pink-500":K.color==="indigo"?"border-indigo-500":"border-amber-500",Qe=K.color==="pink"?"bg-pink-50 dark:bg-pink-900/20":K.color==="indigo"?"bg-indigo-50 dark:bg-indigo-900/20":"bg-amber-50 dark:bg-amber-900/20";return k.jsxs("button",{onClick:()=>{K.id==="FRIENDS"?N():K.id==="BOTS"?j():X()},className:`
                                                    ...
                                                    `,children:[k.jsx("span",{className:"text-2xl font-emoji",children:St(K.icon)}),k.jsx("span",{className:`text-xs font-black uppercase ${te?Ae:"text-slate-400"}`,children:K.label})]},K.id)})}),k.jsx("p",{className:"text-xs text-slate-400 font-medium pt-2",children:x==="FRIENDS"?"4 Players, No Bots":x==="BOTS"?"1 Human vs 3 Bots":"Mix Humans & Bots"})]})]}),x==="CUSTOM"&&k.jsxs("div",{className:"animate-fade-in bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-6 border-2 border-dashed border-amber-200 dark:border-amber-900/50",children:[k.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12",children:[k.jsx(de,{label:"Friends",value:p,onChange:H,min:1,max:4,icon:"🥳",baseColor:"pink"}),k.jsx(de,{label:"Bots",value:E,onChange:B,min:0,max:3,icon:"🤖",baseColor:"violet"})]}),k.jsx("div",{className:"mt-6",children:k.jsx("div",{className:`
                                        ...
                                        `,children:R?`${w} Players Ready`:"Must have 2 to 4 players"})})]}),o==="KIDS"&&k.jsxs("div",{className:"space-y-4 animate-fade-in",children:[k.jsxs("div",{className:"flex items-center justify-center gap-2",children:[k.jsx("span",{className:"text-xl",children:"🧸"}),k.jsx("h3",{className:"text-sm font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400",children:"Choose Characters"})]}),k.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-3 gap-4",children:br.map(K=>k.jsxs("button",{onClick:()=>d(K.id),className:`
                                                ...
                                                `,children:[k.jsxs("div",{className:"flex items-center gap-1 text-2xl group-hover:scale-110 transition-transform",children:[k.jsx("span",{children:K.icons[W.ONE]}),k.jsx("span",{children:K.icons[W.TWO]}),k.jsx("span",{children:K.icons[W.THREE]}),k.jsx("span",{children:K.icons[W.FOUR]})]}),k.jsx("span",{className:`text-xs font-bold uppercase tracking-wide font-sans ${h===K.id?"text-indigo-600 dark:text-indigo-400":"text-slate-500"}`,children:K.name})]},K.id))})]}),k.jsx("div",{className:"pt-4 max-w-sm mx-auto",children:k.jsx(Fn,{onClick:P,disabled:!R,size:"lg",className:"w-full !text-2xl !py-6 !rounded-3xl shadow-xl shadow-blue-500/30 !bg-blue-600 hover:!bg-blue-500 transform hover:scale-[1.02] transition-all disabled:opacity-50 disabled:scale-100 disabled:shadow-none",children:"Start Game"})})]})]})})]}):k.jsxs("div",{className:"flex flex-col h-screen w-full bg-slate-100 dark:bg-slate-900 overflow-hidden relative transition-colors duration-500",children:[k.jsxs("div",{className:"absolute inset-0 pointer-events-none opacity-40",children:[k.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-400/20 dark:bg-blue-900/20 rounded-full blur-[100px]"}),k.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-yellow-400/20 dark:bg-yellow-900/20 rounded-full blur-[100px]"})]}),k.jsxs("header",{className:"shrink-0 h-16 md:h-20 px-3 md:px-8 flex items-center justify-between z-30 bg-white/60 dark:bg-black/20 backdrop-blur-md border-b border-slate-200 dark:border-white/5 relative shadow-sm transition-colors duration-300",children:[k.jsx("div",{className:"flex-1 flex justify-start items-center min-w-0",children:k.jsxs("div",{className:"flex items-center gap-3",children:[k.jsx("div",{className:`
                        ...
                        `,children:n===W.ONE?"1":n===W.TWO?"2":n===W.THREE?"3":"4"}),k.jsxs("div",{className:"flex flex-col",children:[k.jsx("span",{className:"text-[10px] uppercase font-bold text-slate-400 leading-tight",children:"Current Turn"}),k.jsxs("span",{className:`text-base md:text-lg font-black ${J} leading-tight flex items-center gap-2`,children:[G?"Bot":m[n].name,G&&k.jsx("span",{className:"text-[10px] font-bold bg-slate-200 dark:bg-slate-700 px-1.5 py-0.5 rounded text-slate-500 uppercase",children:"Thinking"})]})]})]})}),k.jsxs("div",{className:"shrink-0 flex gap-2 mx-2",children:[k.jsx(Fn,{variant:"icon",size:"sm",onClick:M,title:"Back to Config",className:"w-9 h-9 md:w-11 md:h-11 p-2",children:k.jsx(bm,{})}),k.jsx(Fn,{variant:"icon",size:"sm",onClick:v,title:"Restart Game",className:"w-9 h-9 md:w-11 md:h-11 p-2",children:k.jsx(Am,{})}),k.jsx(Fn,{variant:"icon",size:"sm",onClick:U,title:"Return to Menu",className:"w-9 h-9 md:w-11 md:h-11 p-2",children:k.jsx(Fo,{})})]}),k.jsx("div",{className:"flex-1"})]}),k.jsx("main",{className:"flex-1 w-full h-full flex flex-col items-center justify-center p-2 pb-10 relative z-10 perspective-1000 overflow-hidden",children:k.jsx("div",{className:`
                    relative aspect-square 
                    portrait:w-full portrait:max-h-full
                    landscape:h-full landscape:max-w-full
                    flex items-center justify-center
                `,children:k.jsx("div",{className:"w-full h-full flex items-center justify-center animate-fade-in relative",children:k.jsx(Wl,{})})})}),k.jsx("div",{className:"absolute inset-0 z-50 pointer-events-none",children:k.jsx(Tm,{})}),i===$n.WON&&k.jsx("div",{className:"fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in pointer-events-auto",children:k.jsxs("div",{className:"bg-white dark:bg-slate-800 p-8 rounded-[2rem] shadow-2xl max-w-sm w-full text-center border-4 border-blue-400 animate-bounce-in",children:[k.jsx("div",{className:"text-6xl mb-4 font-emoji",children:St("🏆")}),k.jsxs("h2",{className:"text-3xl font-black text-slate-900 dark:text-white mb-2",children:[c.includes(r)?m[r].name:"Bot"," Wins!"]}),k.jsx("p",{className:"text-slate-500 dark:text-slate-400 font-medium mb-8",children:"A fantastic victory on the board!"}),k.jsxs("div",{className:"flex flex-col gap-3",children:[k.jsx(Fn,{onClick:v,size:"lg",className:"w-full !rounded-xl !py-4 shadow-lg !bg-blue-600 hover:!bg-blue-500",children:"Play Again"}),k.jsx(Fn,{onClick:M,variant:"secondary",className:"w-full !rounded-xl !py-4",children:"Back to Settings"})]})]})})]})};export{Pm as LittleLudoGame};
