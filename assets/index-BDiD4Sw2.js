import{P as W,f as St,c as Dl,p as Qt,u as oa,r as ct,j as z,B as Fn,V as Il}from"./index-KvtTXNEV.js";var $n=(i=>(i.IDLE="IDLE",i.PLAYING="PLAYING",i.WON="WON",i))($n||{});const Ll=15,be=40,Ri=14,Da=250,Nl={2:[W.ONE,W.THREE],3:[W.ONE,W.TWO,W.THREE],4:[W.ONE,W.TWO,W.THREE,W.FOUR]},Ul={STANDARD:{name:"Classic",boardBg:16777215,safeStar:13358561,gridStroke:14870768,players:{[W.ONE]:{main:3900150,light:14412542,label:"Blue"},[W.TWO]:{main:15680580,light:16704226,label:"Red"},[W.THREE]:{main:1096065,light:13761253,label:"Green"},[W.FOUR]:{main:15381256,light:16710083,label:"Yellow"}}},KIDS:{name:"Kiddo",boardBg:16642808,safeStar:16502760,gridStroke:16574451,players:{[W.ONE]:{main:6514417,light:14739455,label:"Indigo"},[W.TWO]:{main:16007006,light:16770278,label:"Rose"},[W.THREE]:{main:1357990,light:13433841,label:"Teal"},[W.FOUR]:{main:16096779,light:16708551,label:"Amber"}}}},Ar=[{id:"zoo",name:"Zoo Party",icons:{[W.ONE]:St("🐧"),[W.TWO]:St("🦊"),[W.THREE]:St("🐸"),[W.FOUR]:St("🦁")}},{id:"pets",name:"Pet Pals",icons:{[W.ONE]:St("🐦"),[W.TWO]:St("🐱"),[W.THREE]:St("🐢"),[W.FOUR]:St("🐶")}},{id:"wild",name:"Wild Ones",icons:{[W.ONE]:St("🐳"),[W.TWO]:St("🐼"),[W.THREE]:St("🐊"),[W.FOUR]:St("🦒")}}],Dr=[{x:6,y:13},{x:6,y:12},{x:6,y:11},{x:6,y:10},{x:6,y:9},{x:5,y:8},{x:4,y:8},{x:3,y:8},{x:2,y:8},{x:1,y:8},{x:0,y:8},{x:0,y:7},{x:0,y:6},{x:1,y:6},{x:2,y:6},{x:3,y:6},{x:4,y:6},{x:5,y:6},{x:6,y:5},{x:6,y:4},{x:6,y:3},{x:6,y:2},{x:6,y:1},{x:6,y:0},{x:7,y:0},{x:8,y:0},{x:8,y:1},{x:8,y:2},{x:8,y:3},{x:8,y:4},{x:8,y:5},{x:9,y:6},{x:10,y:6},{x:11,y:6},{x:12,y:6},{x:13,y:6},{x:14,y:6},{x:14,y:7},{x:14,y:8},{x:13,y:8},{x:12,y:8},{x:11,y:8},{x:10,y:8},{x:9,y:8},{x:8,y:9},{x:8,y:10},{x:8,y:11},{x:8,y:12},{x:8,y:13},{x:8,y:14},{x:7,y:14},{x:6,y:14}],vr={[W.ONE]:[{x:7,y:13},{x:7,y:12},{x:7,y:11},{x:7,y:10},{x:7,y:9},{x:7,y:8}],[W.TWO]:[{x:1,y:7},{x:2,y:7},{x:3,y:7},{x:4,y:7},{x:5,y:7},{x:6,y:7}],[W.THREE]:[{x:7,y:1},{x:7,y:2},{x:7,y:3},{x:7,y:4},{x:7,y:5},{x:7,y:6}],[W.FOUR]:[{x:13,y:7},{x:12,y:7},{x:11,y:7},{x:10,y:7},{x:9,y:7},{x:8,y:7}]},wr={[W.ONE]:0,[W.TWO]:13,[W.THREE]:26,[W.FOUR]:39},Fl={[W.ONE]:[{x:1,y:10},{x:4,y:10},{x:1,y:13},{x:4,y:13}],[W.TWO]:[{x:1,y:1},{x:4,y:1},{x:1,y:4},{x:4,y:4}],[W.THREE]:[{x:10,y:1},{x:13,y:1},{x:10,y:4},{x:13,y:4}],[W.FOUR]:[{x:10,y:10},{x:13,y:10},{x:10,y:13},{x:13,y:13}]},Ol=Dr.length,Bl=(i,e,t)=>{if(e===-1)return Fl[i][t];if(e===99){const o=(t-.5)*.4;return{x:7+o,y:7+o}}if(e>=52){const s=e-52;return vr[i]&&vr[i][s]?vr[i][s]:{x:7,y:7}}const n=wr[i],r=(e+n)%Ol;return Dr[r]||{x:0,y:0}},Bo=(i,e)=>i.position===-1?e===6:!(i.position+e>57),zl=Dr.length,Ia=(i,e)=>(i+wr[e])%zl,kl=(i,e,t)=>{const n=i.filter(a=>a.playerId===t&&Bo(a,e));if(n.length===0)return null;if(n.length===1)return n[0].id;let r=n[0],s=-1/0;return n.forEach(a=>{let o=0;const c=a.position,l=c===-1?0:c+e;if(c===-1&&(o+=100),l<52){const d=Ia(l,t);i.find(f=>f.playerId!==t&&f.position!==-1&&f.position<52&&Ia(f.position,f.playerId)===d)&&([0,8,13,21,26,34,39,47].includes(d)||(o+=200))}l===99&&(o+=150),c<52&&l>=52&&(o+=50),o+=l,o+=Math.random()*5,o>s&&(s=o,r=a)}),r.id},zo="little-ludo-state-v4",ko=[{id:"p1-0",playerId:W.ONE,position:-1},{id:"p1-1",playerId:W.ONE,position:-1},{id:"p1-2",playerId:W.ONE,position:-1},{id:"p1-3",playerId:W.ONE,position:-1},{id:"p2-0",playerId:W.TWO,position:-1},{id:"p2-1",playerId:W.TWO,position:-1},{id:"p2-2",playerId:W.TWO,position:-1},{id:"p2-3",playerId:W.TWO,position:-1},{id:"p3-0",playerId:W.THREE,position:-1},{id:"p3-1",playerId:W.THREE,position:-1},{id:"p3-2",playerId:W.THREE,position:-1},{id:"p3-3",playerId:W.THREE,position:-1},{id:"p4-0",playerId:W.FOUR,position:-1},{id:"p4-1",playerId:W.FOUR,position:-1},{id:"p4-2",playerId:W.FOUR,position:-1},{id:"p4-3",playerId:W.FOUR,position:-1}],mn=()=>Math.floor(Math.random()*9)+7,La=()=>{let i={};if(typeof window<"u")try{const e=localStorage.getItem(zo);e&&(i=JSON.parse(e))}catch{}return{turn:W.ONE,diceValue:null,tokens:JSON.parse(JSON.stringify(ko)),winner:null,gameMode:"PVP",difficulty:"EASY",themeId:"KIDS",characterSetId:Ar[0].id,playerCount:2,activePlayers:[W.ONE,W.THREE],humanPlayers:[W.ONE,W.THREE],isRolling:!1,canRoll:!0,isMovingToken:!1,isBotThinking:!1,highlightedTokens:[],rollsWithoutSix:{[W.ONE]:0,[W.TWO]:0,[W.THREE]:0,[W.FOUR]:0},pityThreshold:{[W.ONE]:mn(),[W.TWO]:mn(),[W.THREE]:mn(),[W.FOUR]:mn()},...i,status:$n.IDLE}},Na=i=>{if(typeof window<"u"){const{themeId:e,characterSetId:t}=i;localStorage.setItem(zo,JSON.stringify({themeId:e,characterSetId:t}))}},pi=Dl((i,e)=>({...La(),startGame:t=>{Qt("start");const n=t.humanCount+t.botCount,r=Math.max(2,Math.min(4,n)),s=Nl[r],a=s.slice(0,t.humanCount),o=t.botCount>0?"PVB":"PVP",c=JSON.parse(JSON.stringify(ko));i({status:$n.PLAYING,gameMode:o,playerCount:r,difficulty:t.difficulty,activePlayers:s,humanPlayers:a,turn:s[0],tokens:c,winner:null,diceValue:null,canRoll:!0,isRolling:!1,isMovingToken:!1,isBotThinking:!1,highlightedTokens:[],rollsWithoutSix:{[W.ONE]:0,[W.TWO]:0,[W.THREE]:0,[W.FOUR]:0},pityThreshold:{[W.ONE]:mn(),[W.TWO]:mn(),[W.THREE]:mn(),[W.FOUR]:mn()}})},setTheme:t=>{Qt("click"),i({themeId:t}),Na({...e(),themeId:t})},setCharacterSet:t=>{Qt("click"),i({characterSetId:t}),Na({...e(),characterSetId:t})},resetGame:()=>{Qt("click"),i(La())},rollDice:()=>{const{isRolling:t,canRoll:n,turn:r,tokens:s,rollsWithoutSix:a,pityThreshold:o,difficulty:c,isBotThinking:l}=e();!n||t||l||(i({isRolling:!0}),setTimeout(()=>{const d=s.some(E=>E.playerId===r&&E.position!==-1);let h;c==="EASY"&&!d&&a[r]+1>=o[r]?h=6:h=Math.floor(Math.random()*6)+1;const f={...a},m={...o};h===6?(f[r]=0,m[r]=mn()):d||(f[r]+=1);const _=s.filter(E=>E.playerId===r&&E.position!==99).filter(E=>Bo(E,h)).map(E=>E.id);i({isRolling:!1,diceValue:h,highlightedTokens:_,canRoll:!1,rollsWithoutSix:f,pityThreshold:m});const{humanPlayers:p}=e();!p.includes(r)?_.length>0?(i({isBotThinking:!0}),setTimeout(()=>{const E=kl(s,h,r);E?e().moveToken(E):Ki()},1e3)):setTimeout(()=>Ki(),1e3):_.length===0&&setTimeout(()=>Ki(),1e3)},1e3))},moveToken:async t=>{const{highlightedTokens:n,tokens:r,diceValue:s,turn:a,isMovingToken:o}=e();if(!n.includes(t)||!s||o)return;i({isMovingToken:!0,highlightedTokens:[],isBotThinking:!1});const c=r.findIndex(_=>_.id===t);if(c===-1)return;let l=r[c].position;if(l===-1){l=0;const _=[...e().tokens];_[c]={..._[c],position:0},i({tokens:_}),Qt("tap"),await new Promise(p=>setTimeout(p,Da))}else for(let _=0;_<s;_++){await new Promise(u=>setTimeout(u,Da)),l++;const p=[...e().tokens];p[c]={...p[c],position:l},i({tokens:p}),Qt("tap")}let d=!1,h=!1;if(l===57){const _=[...e().tokens];_[c]={..._[c],position:99},i({tokens:_}),Qt("win"),h=!0}else if(l<52){const _=wr[a],p=(l+_)%52,u=[...e().tokens];let E=!1;u.forEach(b=>{if(b.playerId!==a&&b.position!==-1&&b.position!==99&&b.position<52){const y=wr[b.playerId],A=(b.position+y)%52;p===A&&([0,8,13,21,26,34,39,47].includes(A)||(b.position=-1,E=!0))}}),E&&(i({tokens:u}),setTimeout(()=>Qt("drop"),100),d=!0)}if(e().tokens.filter(_=>_.playerId===a).every(_=>_.position===99))i({status:$n.WON,winner:a,isMovingToken:!1}),Qt("win");else if(s===6||d||h){i({diceValue:null,canRoll:!0,isMovingToken:!1,highlightedTokens:[]});const{humanPlayers:_}=e();_.includes(a)||setTimeout(()=>e().rollDice(),1e3)}else Ki()}})),Ki=()=>{const i=pi.getState(),{activePlayers:e,turn:t,humanPlayers:n}=i,s=(e.indexOf(t)+1)%e.length,a=e[s];pi.setState({turn:a,diceValue:null,canRoll:!0,isMovingToken:!1,highlightedTokens:[],isBotThinking:!1}),n.includes(a)||setTimeout(()=>pi.getState().rollDice(),1e3)},Vl=1.5,Hl=1.5,vt=i=>"#"+i.toString(16).padStart(6,"0"),Gl=(i,e,t,n,r)=>{const[s,a,o,c]=r;return`
        ...
        Q ${i} ${e} ${i+s} ${e}
        Z
    `},Wl=()=>{const{tokens:i,highlightedTokens:e,moveToken:t,turn:n,themeId:r,characterSetId:s,activePlayers:a,humanPlayers:o}=pi(),{enableTilt:c,players:l}=oa(),d=Ll*be,h=Ul[r],f=ct.useMemo(()=>Ar.find(u=>u.id===s)||Ar[0],[s]),m=ct.useMemo(()=>{const u=[];u.push(z.jsx("rect",{x:0,y:0,width:d,height:d,fill:vt(h.boardBg)},"bg"));const E=(y,A,w,R)=>{const N=a.includes(y),S=N?vt(h.players[y].main):"#cbd5e1",M=N?vt(h.players[y].light):"#f1f5f9",P=N?.15:.05;let V=R;return N&&!o.includes(y)&&(V="Bot"),z.jsxs("g",{style:{opacity:N?1:.6},children:[z.jsx("rect",{x:A*be,y:w*be,width:6*be,height:6*be,fill:S,opacity:P}),z.jsx("rect",{x:(A+.5)*be,y:(w+.5)*be,width:5*be,height:5*be,fill:M,rx:20}),N&&z.jsx("text",{x:(A+3)*be,y:(w+3.2)*be,textAnchor:"middle",fill:"black",opacity:"0.1",fontWeight:"900",fontSize:"32",style:{textTransform:"uppercase"},children:V})]},`base-${y}`)};u.push(E(W.TWO,0,0,l[W.TWO].name)),u.push(E(W.THREE,9,0,l[W.THREE].name)),u.push(E(W.ONE,0,9,l[W.ONE].name)),u.push(E(W.FOUR,9,9,l[W.FOUR].name)),Dr.forEach((y,A)=>{let R=[0,8,13,21,26,34,39,47].includes(A)?vt(h.safeStar):"#ffffff";A===0&&(R=a.includes(W.ONE)?vt(h.players[W.ONE].light):R),A===13&&(R=a.includes(W.TWO)?vt(h.players[W.TWO].light):R),A===26&&(R=a.includes(W.THREE)?vt(h.players[W.THREE].light):R),A===39&&(R=a.includes(W.FOUR)?vt(h.players[W.FOUR].light):R),u.push(z.jsx("rect",{x:y.x*be,y:y.y*be,width:be,height:be,fill:R,stroke:vt(h.gridStroke),strokeWidth:1},`main-${A}`))});const b=y=>{a.includes(y)&&vr[y].forEach((A,w)=>{u.push(z.jsx("rect",{x:A.x*be,y:A.y*be,width:be,height:be,fill:vt(h.players[y].main),opacity:.3,stroke:vt(h.gridStroke)},`h-${y}-${w}`))})};return[W.ONE,W.TWO,W.THREE,W.FOUR].forEach(y=>b(y)),u.push(z.jsx("rect",{x:6*be,y:6*be,width:3*be,height:3*be,fill:"#f8fafc"},"center-bg")),u.push(z.jsx("polygon",{points:`${6*be},${9*be} ${9*be},${9*be} ${7.5*be},${7.5*be}`,fill:vt(h.players[W.ONE].main),opacity:a.includes(W.ONE)?1:.2},"c-p1")),u.push(z.jsx("polygon",{points:`${6*be},${6*be} ${6*be},${9*be} ${7.5*be},${7.5*be}`,fill:vt(h.players[W.TWO].main),opacity:a.includes(W.TWO)?1:.2},"c-p2")),u.push(z.jsx("polygon",{points:`${6*be},${6*be} ${9*be},${6*be} ${7.5*be},${7.5*be}`,fill:vt(h.players[W.THREE].main),opacity:a.includes(W.THREE)?1:.2},"c-p3")),u.push(z.jsx("polygon",{points:`${9*be},${6*be} ${9*be},${9*be} ${7.5*be},${7.5*be}`,fill:vt(h.players[W.FOUR].main),opacity:a.includes(W.FOUR)?1:.2},"c-p4")),u},[d,l,h,a,o]),v=u=>vt(h.players[u].main),_=[{id:W.TWO,label:h.players[W.TWO].label,x:0,y:0,w:2,h:1,color:h.players[W.TWO].main,radii:[0,8,24,8]},{id:W.THREE,label:h.players[W.THREE].label,x:13,y:0,w:2,h:1,color:h.players[W.THREE].main,radii:[8,0,8,24]},{id:W.FOUR,label:h.players[W.FOUR].label,x:13,y:14,w:2,h:1,color:h.players[W.FOUR].main,radii:[24,8,0,8]},{id:W.ONE,label:h.players[W.ONE].label,x:0,y:14,w:2,h:1,color:h.players[W.ONE].main,radii:[8,24,8,0]}].map(u=>{if(!a.includes(u.id))return null;const E=n===u.id,b=u.w*be,y=u.h*be,A=Gl(u.x*be,u.y*be,b,y,u.radii),w=u.x*be+b/2,R=u.y*be+y/2;return z.jsxs("g",{className:E?"marker-pulsating":"",style:{transformOrigin:`${w}px ${R}px`},children:[z.jsx("path",{d:A,fill:vt(u.color),stroke:"none",style:{filter:E?"drop-shadow(0 0 4px rgba(0,0,0,0.3))":"none"}}),z.jsx("text",{x:w,y:R+7,textAnchor:"middle",fill:"white",fontSize:"18",fontWeight:"900",style:{textShadow:"0px 1px 2px rgba(0,0,0,0.3)",textTransform:"uppercase"},children:u.label})]},`marker-${u.id}`)}),p=ct.useMemo(()=>{const u=i.filter(y=>a.includes(y.playerId)),E={};u.forEach(y=>{const A=parseInt(y.id.split("-")[1]),{x:w,y:R}=Bl(y.playerId,y.position,A),N=`${w.toFixed(3)},${R.toFixed(3)}`;E[N]||(E[N]=[]),E[N].push({token:y,x:w,y:R})});const b=[];return Object.values(E).forEach(y=>{y.sort((A,w)=>{const R=e.includes(A.token.id),N=e.includes(w.token.id);if(R&&!N)return 1;if(!R&&N)return-1;const S=A.token.playerId===n,M=w.token.playerId===n;return S&&!M?1:!S&&M?-1:A.token.id.localeCompare(w.token.id)}),y.forEach((A,w)=>{b.push({...A,stackIndex:w,isTop:w===y.length-1})})}),b},[i,e,n,a]);return z.jsxs("div",{className:"w-full h-full flex justify-center items-center",children:[z.jsx("style",{children:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
                        ...
                        `,children:z.jsx(wm,{})}),z.jsx("span",{className:`text-5xl font-black w-12 text-center ${te.text}`,children:ne}),z.jsx("button",{onClick:()=>Ae(ne+1),disabled:ne>=ke,className:`
                            w-14 h-14 flex items-center justify-center rounded-full 
                            bg-white dark:bg-slate-800 shadow-[0_4px_0_rgba(0,0,0,0.1)] active:shadow-none active:translate-y-1
                            ${ne>=ke?"opacity-30 cursor-not-allowed":"hover:scale-105 active:scale-95"}
                            ${te.btnText} transition-all duration-200
                        `,children:z.jsx(Am,{})})]})]})};return i===$n.IDLE?z.jsxs("div",{className:"flex flex-col h-screen w-full bg-slate-50 dark:bg-[#0f172a] overflow-hidden relative transition-colors duration-500 text-slate-900 dark:text-white",children:[z.jsxs("div",{className:"absolute inset-0 pointer-events-none opacity-40",children:[z.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-400/20 dark:bg-blue-900/20 rounded-full blur-[100px]"}),z.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-green-400/20 dark:bg-green-900/20 rounded-full blur-[100px]"})]}),z.jsx("header",{className:"shrink-0 h-16 md:h-20 px-4 flex items-center justify-center bg-white/50 dark:bg-slate-900/50 backdrop-blur-md z-30 sticky top-0 border-b border-slate-200/50 dark:border-white/5",children:z.jsx(Fn,{variant:"icon",size:"sm",onClick:N,title:"Return to Menu",children:z.jsx(Oo,{})})}),z.jsx("div",{className:"flex-1 overflow-y-auto p-4 md:p-8 pb-24",children:z.jsxs("div",{className:"max-w-4xl mx-auto space-y-10 text-center relative z-20",children:[z.jsxs("div",{className:"space-y-4 animate-fade-in pt-4",children:[z.jsx("div",{className:`
                            ...
                            `,children:z.jsx("span",{className:"text-6xl font-emoji",children:o==="KIDS"?St("🐧"):St("🎲")})}),z.jsx("h1",{className:"text-5xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tighter drop-shadow-sm",children:"Little Ludo"}),z.jsx("div",{className:"flex justify-center mt-4",children:z.jsxs("div",{className:"bg-slate-200 dark:bg-slate-800 p-1.5 rounded-2xl inline-flex shadow-inner",children:[z.jsx("button",{onClick:()=>c("KIDS"),className:`
                                        ...
                                        `,children:"🐧 Kiddo"}),z.jsx("button",{onClick:()=>c("STANDARD"),className:`
                                            px-6 py-2.5 rounded-xl text-sm font-bold uppercase tracking-wider transition-all
                                        ...
                                        `,children:"🎲 Classic"})]})})]}),z.jsxs("div",{className:"max-w-4xl mx-auto space-y-8 animate-fade-in",style:{animationDelay:"100ms"},children:[z.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8",children:[z.jsxs("div",{className:"bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-700 space-y-4",children:[z.jsx("h2",{className:"text-sm font-bold uppercase tracking-widest text-slate-400 text-center",children:"Difficulty"}),z.jsxs("div",{className:"flex gap-3",children:[z.jsxs("button",{onClick:()=>A("EASY"),className:`
                                            ...
                                            `,children:[z.jsx("span",{className:"text-3xl",children:"😊"}),z.jsx("span",{children:"Easy"})]}),z.jsxs("button",{onClick:()=>A("NORMAL"),className:`
                                                flex-1 p-4 rounded-2xl font-bold transition-all border-4 flex flex-col items-center gap-1
                                            ...
                                            `,children:[z.jsx("span",{className:"text-3xl",children:"😎"}),z.jsx("span",{children:"Normal"})]})]}),z.jsx("p",{className:"text-xs text-slate-400 font-medium pt-2",children:y==="EASY"?"Forgiving rules & more 6s!":"Standard Ludo rules apply."})]}),z.jsxs("div",{className:"bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-700 space-y-4",children:[z.jsx("h2",{className:"text-sm font-bold uppercase tracking-widest text-slate-400 text-center",children:"Game Mode"}),z.jsx("div",{className:"grid grid-cols-3 gap-2",children:[{id:"FRIENDS",label:"Friends",icon:"👥",color:"pink"},{id:"BOTS",label:"Bots",icon:"🤖",color:"indigo"},{id:"CUSTOM",label:"Custom",icon:"🛠️",color:"amber"}].map(J=>{const ne=v===J.id,Ae=J.color==="pink"?"text-pink-500":J.color==="indigo"?"text-indigo-500":"text-amber-500",Ce=J.color==="pink"?"border-pink-500":J.color==="indigo"?"border-indigo-500":"border-amber-500",ke=J.color==="pink"?"bg-pink-50 dark:bg-pink-900/20":J.color==="indigo"?"bg-indigo-50 dark:bg-indigo-900/20":"bg-amber-50 dark:bg-amber-900/20";return z.jsxs("button",{onClick:()=>{J.id==="FRIENDS"?q():J.id==="BOTS"?$():G()},className:`
                                                    ...
                                                    `,children:[z.jsx("span",{className:"text-2xl font-emoji",children:St(J.icon)}),z.jsx("span",{className:`text-xs font-black uppercase ${ne?Ae:"text-slate-400"}`,children:J.label})]},J.id)})}),z.jsx("p",{className:"text-xs text-slate-400 font-medium pt-2",children:v==="FRIENDS"?"4 Players, No Bots":v==="BOTS"?"1 Human vs 3 Bots":"Mix Humans & Bots"})]})]}),v==="CUSTOM"&&z.jsxs("div",{className:"animate-fade-in bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-6 border-2 border-dashed border-amber-200 dark:border-amber-900/50",children:[z.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12",children:[z.jsx(Y,{label:"Friends",value:p,onChange:V,min:1,max:4,icon:"🥳",baseColor:"pink"}),z.jsx(Y,{label:"Bots",value:E,onChange:O,min:0,max:3,icon:"🤖",baseColor:"violet"})]}),z.jsx("div",{className:"mt-6",children:z.jsx("div",{className:`
                                        ...
                                        `,children:R?`${w} Players Ready`:"Must have 2 to 4 players"})})]}),o==="KIDS"&&z.jsxs("div",{className:"space-y-4 animate-fade-in",children:[z.jsxs("div",{className:"flex items-center justify-center gap-2",children:[z.jsx("span",{className:"text-xl",children:"🧸"}),z.jsx("h3",{className:"text-sm font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400",children:"Choose Characters"})]}),z.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-3 gap-4",children:Ar.map(J=>z.jsxs("button",{onClick:()=>h(J.id),className:`
                        ...
                        `,children:n===W.ONE?"1":n===W.TWO?"2":n===W.THREE?"3":"4"}),z.jsxs("div",{className:"flex flex-col",children:[z.jsx("span",{className:"text-[10px] uppercase font-bold text-slate-400 leading-tight",children:"Current Turn"}),z.jsxs("span",{className:`text-base md:text-lg font-black ${Z} leading-tight flex items-center gap-2`,children:[H?"Bot":m[n].name,H&&z.jsx("span",{className:"text-[10px] font-bold bg-slate-200 dark:bg-slate-700 px-1.5 py-0.5 rounded text-slate-500 uppercase",children:"Thinking"})]})]})]})}),z.jsxs("div",{className:"shrink-0 flex gap-2 mx-2",children:[z.jsx(Fn,{variant:"icon",size:"sm",onClick:M,title:"Back to Config",className:"w-9 h-9 md:w-11 md:h-11 p-2",children:z.jsx(Tm,{})}),z.jsx(Fn,{variant:"icon",size:"sm",onClick:S,title:"Restart Game",className:"w-9 h-9 md:w-11 md:h-11 p-2",children:z.jsx(bm,{})}),z.jsx(Fn,{variant:"icon",size:"sm",onClick:N,title:"Return to Menu",className:"w-9 h-9 md:w-11 md:h-11 p-2",children:z.jsx(Oo,{})})]}),z.jsx("div",{className:"flex-1"})]}),z.jsx("main",{className:"flex-1 w-full h-full flex flex-col items-center justify-center p-2 pb-10 relative z-10 perspective-1000 overflow-hidden",children:z.jsx("div",{className:`
                    relative aspect-square 
                    portrait:w-full portrait:max-h-full
                    landscape:h-full landscape:max-w-full
                    flex items-center justify-center
                `,children:z.jsx("div",{className:"w-full h-full flex items-center justify-center animate-fade-in relative",children:z.jsx(Wl,{})})})}),z.jsx("div",{className:"absolute inset-0 z-50 pointer-events-none",children:z.jsx(ym,{})}),i===$n.WON&&z.jsx("div",{className:"fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in pointer-events-auto",children:z.jsxs("div",{className:"bg-white dark:bg-slate-800 p-8 rounded-[2rem] shadow-2xl max-w-sm w-full text-center border-4 border-blue-400 animate-bounce-in",children:[z.jsx("div",{className:"text-6xl mb-4 font-emoji",children:St("🏆")}),z.jsxs("h2",{className:"text-3xl font-black text-slate-900 dark:text-white mb-2",children:[l.includes(r)?m[r].name:"Bot"," Wins!"]}),z.jsx("p",{className:"text-slate-500 dark:text-slate-400 font-medium mb-8",children:"A fantastic victory on the board!"}),z.jsxs("div",{className:"flex flex-col gap-3",children:[z.jsx(Fn,{onClick:S,size:"lg",className:"w-full !rounded-xl !py-4 shadow-lg !bg-blue-600 hover:!bg-blue-500",children:"Play Again"}),z.jsx(Fn,{onClick:M,variant:"secondary",className:"w-full !rounded-xl !py-4",children:"Back to Settings"})]})]})})]})};export{Cm as LittleLudoGame};
