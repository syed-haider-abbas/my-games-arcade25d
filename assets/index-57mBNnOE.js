...
`)+`
`+d);const E=T+p+a,b=T+d+o,w=Ao(r,r.VERTEX_SHADER,E),A=Ao(r,r.FRAGMENT_SHADER,b);r.attachShader(_,w),r.attachShader(_,A),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function R(P){if(i.debug.checkShaderErrors){const G=r.getProgramInfoLog(_)||"",O=r.getShaderInfoLog(w)||"",k=r.getShaderInfoLog(A)||"",j=G.trim(),H=O.trim(),X=k.trim();let Z=!0,$=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,_,w,A);else{const oe=Ro(r,w,"vertex"),fe=Ro(r,A,"fragment");Xe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `,children:i[0]}),B.jsxs("div",{className:"flex-1",children:[B.jsx("div",{className:"font-bold text-slate-900 dark:text-white text-lg",children:i}),B.jsx("div",{className:"text-slate-500 dark:text-slate-400 text-sm font-medium",children:e})]}),r&&B.jsx("div",{className:"ml-auto text-xl text-slate-900 dark:text-white font-bold animate-bounce-in",children:"✓"})]}),fi=({label:i,icon:e,isSelected:t,onClick:n,colorClass:r})=>B.jsxs("button",{onClick:s=>{s.stopPropagation(),n()},className:`
        ...
        `,children:[B.jsx("span",{className:"text-2xl drop-shadow-sm filter",children:Be(e)}),B.jsx("span",{className:"text-[10px] font-black uppercase tracking-wide",children:i})]}),ko=({title:i,subtitle:e,icon:t,colorClass:n,selected:r,onClick:s,children:a})=>B.jsxs("div",{className:`relative flex flex-col ${r?"flex-[1.5]":"flex-1"} transition-[flex] duration-300`,children:[B.jsxs("button",{onClick:s,className:`
            ...
            `}),B.jsxs("div",{className:"relative z-10 flex items-center gap-4 mb-2",children:[B.jsx("div",{className:`
                    ...
                    ${n}
                `,children:Be(t)}),B.jsxs("div",{children:[B.jsx("h3",{className:"text-lg font-black text-slate-900 dark:text-white leading-tight",children:i}),B.jsx("p",{className:"text-slate-500 dark:text-slate-400 font-medium text-xs",children:e})]})]})]}),r&&a&&B.jsx("div",{className:"mt-4 animate-fade-in origin-top grid grid-cols-3 gap-3 p-1",children:a})]}),wm=()=>{const{status:i,startGame:e,resumeGame:t,resetGame:n,turn:r,winner:s,difficulty:a,playerCount:o,themeId:c,setTheme:l,humanPlayers:u,characterSetId:h,setCharacterSet:f,hasSavedGame:m}=mi(),{setView:v,players:_}=oa(),[p,d]=ct.useState("FRIENDS"),[T,E]=ct.useState(4),[b,w]=ct.useState(1),[A,R]=ct.useState("EASY");ct.useEffect(()=>{if(i===Ot.IDLE){a&&R(a);const k=Math.max(1,u.length),j=o||4,H=j-k;k>1?(d("FRIENDS"),E(j)):(d("BOTS"),w(H))}},[a,o,u,i]);const N=()=>{n(),v(Ll.HOME)},x=()=>{const k=p==="FRIENDS";e({humanCount:k?T:1,botCount:k?0:b,difficulty:A})},M=()=>{n()},P=()=>{const k=p==="FRIENDS";e({humanCount:k?T:1,botCount:k?0:b,difficulty:A})},G=!u.includes(r),O=r===W.ONE?"text-blue-500":r===W.TWO?"text-red-500":r===W.THREE?"text-green-500":"text-yellow-500";return i===Ot.IDLE?B.jsxs("div",{className:"flex flex-col h-screen w-full bg-slate-50 dark:bg-[#0f172a] overflow-hidden relative transition-colors duration-500 text-slate-900 dark:text-white",children:[B.jsxs("div",{className:"absolute inset-0 pointer-events-none opacity-40",children:[B.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-400/20 dark:bg-blue-900/20 rounded-full blur-[100px]"}),B.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-green-400/20 dark:bg-green-900/20 rounded-full blur-[100px]"})]}),B.jsx("header",{className:"shrink-0 h-16 md:h-20 px-4 flex items-center justify-center bg-white/50 dark:bg-slate-900/50 backdrop-blur-md z-30 sticky top-0 border-b border-slate-200/50 dark:border-white/5",children:B.jsx(An,{variant:"icon",size:"sm",onClick:N,title:"Return to Menu",children:B.jsx(Oo,{})})}),B.jsx("div",{className:"flex-1 overflow-y-auto p-4 md:p-8 pb-32",children:B.jsxs("div",{className:"max-w-4xl mx-auto space-y-10 text-center relative z-20",children:[m&&B.jsxs("div",{className:"animate-pop",children:[B.jsxs("div",{className:"bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-xl border-l-8 border-indigo-500 flex flex-col sm:flex-row items-center justify-between gap-6 max-w-2xl mx-auto ring-1 ring-slate-900/5",children:[B.jsxs("div",{className:"text-left",children:[B.jsx("h2",{className:"text-2xl font-black text-slate-900 dark:text-white",children:"Game in Progress"}),B.jsx("p",{className:"text-slate-500 dark:text-slate-400 font-medium",children:"Resume your match"})]}),B.jsx(An,{onClick:t,size:"lg",className:"w-full sm:w-auto !bg-indigo-500 hover:!bg-indigo-400 whitespace-nowrap !rounded-xl !py-4 !px-8 text-lg shadow-lg shadow-indigo-500/30",children:"Continue Game"})]}),B.jsxs("div",{className:"flex items-center gap-4 mt-8 mb-4 max-w-2xl mx-auto",children:[B.jsx("div",{className:"h-px bg-slate-200 dark:bg-slate-700 flex-1"}),B.jsx("span",{className:"text-xs font-bold uppercase tracking-widest text-slate-400",children:"Or Start New Game"}),B.jsx("div",{className:"h-px bg-slate-200 dark:bg-slate-700 flex-1"})]})]}),B.jsx("div",{className:"flex justify-center pt-4 animate-fade-in",children:B.jsxs("div",{className:"bg-slate-200 dark:bg-slate-800 p-1.5 rounded-full inline-flex shadow-inner",children:[B.jsxs("button",{onClick:()=>l("KIDS"),className:`
                                    ...
                                    `,children:[B.jsx("span",{children:"🐧"})," Kiddo"]}),B.jsxs("button",{onClick:()=>l("STANDARD"),className:`
                                        flex items-center gap-2 px-6 py-2 rounded-full text-sm font-black uppercase tracking-wider transition-all
                                    ...
                                    `,children:[B.jsx("span",{children:"🎲"})," Classic"]})]})}),c==="KIDS"&&B.jsxs("div",{className:"space-y-4 animate-fade-in",children:[B.jsx("h3",{className:"text-sm font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400",children:"Choose Characters"}),B.jsx("div",{className:"grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl mx-auto",children:Ar.map(k=>B.jsxs("button",{onClick:()=>f(k.id),className:`
                                            ...
                                            `,children:[B.jsxs("div",{className:"relative w-full aspect-square mb-2 bg-slate-100 dark:bg-slate-700/50 rounded-2xl p-2 grid grid-cols-2 grid-rows-2 gap-1",children:[B.jsx("div",{className:"absolute inset-0 flex items-center justify-center z-10 pointer-events-none",children:B.jsx("div",{className:"bg-white dark:bg-slate-900 rounded-full px-2 py-1 text-[10px] font-black tracking-widest shadow-sm border border-slate-100 dark:border-slate-700 text-slate-300 dark:text-slate-600",children:"VS"})}),B.jsx("div",{className:"flex items-center justify-center text-3xl md:text-4xl filter drop-shadow-sm",children:k.icons[W.ONE]}),B.jsx("div",{className:"flex items-center justify-center text-3xl md:text-4xl filter drop-shadow-sm",children:k.icons[W.TWO]}),B.jsx("div",{className:"flex items-center justify-center text-3xl md:text-4xl filter drop-shadow-sm",children:k.icons[W.FOUR]}),B.jsx("div",{className:"flex items-center justify-center text-3xl md:text-4xl filter drop-shadow-sm",children:k.icons[W.THREE]})]}),B.jsx("span",{className:`text-xs font-black uppercase tracking-wider ${h===k.id?"text-indigo-600 dark:text-indigo-400":"text-slate-500"}`,children:k.name})]},k.id))})]}),B.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start text-left max-w-4xl mx-auto animate-fade-in",style:{animationDelay:"100ms"},children:[B.jsxs("div",{className:"space-y-6",children:[B.jsxs("div",{className:"flex items-center gap-4 justify-center md:justify-start",children:[B.jsx("div",{className:"w-8 h-8 rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 flex items-center justify-center font-bold text-sm",children:"1"}),B.jsx("h2",{className:"text-lg font-black uppercase tracking-widest text-slate-500 dark:text-slate-400",children:"Difficulty"})]}),B.jsxs("div",{className:"space-y-3",children:[B.jsx(Bo,{label:"Easy",desc:"Forgiving rules, more 6s",color:"bg-amber-400",ring:"ring-amber-400",selected:A==="EASY",onClick:()=>R("EASY")}),B.jsx(Bo,{label:"Classic",desc:"Standard Ludo rules",color:"bg-emerald-400",ring:"ring-emerald-400",selected:A==="NORMAL",onClick:()=>R("NORMAL")})]})]}),B.jsxs("div",{className:"space-y-6",children:[B.jsxs("div",{className:"flex items-center gap-4 justify-center md:justify-start",children:[B.jsx("div",{className:"w-8 h-8 rounded-full bg-pink-100 dark:bg-pink-900/30 text-pink-600 dark:text-pink-400 flex items-center justify-center font-bold text-sm",children:"2"}),B.jsx("h2",{className:"text-lg font-black uppercase tracking-widest text-slate-500 dark:text-slate-400",children:"Game Mode"})]}),B.jsxs("div",{className:"flex flex-col gap-4",children:[B.jsxs(ko,{title:"Vs Friend",subtitle:"Pass & Play",icon:"👥",colorClass:"bg-pink-500",selected:p==="FRIENDS",onClick:()=>d("FRIENDS"),children:[B.jsx(fi,{label:"2 Players",icon:"👤👤",isSelected:T===2,onClick:()=>E(2),colorClass:"bg-pink-500"}),B.jsx(fi,{label:"3 Players",icon:"👤👤👤",isSelected:T===3,onClick:()=>E(3),colorClass:"bg-pink-500"}),B.jsx(fi,{label:"4 Players",icon:"👤👤👤👤",isSelected:T===4,onClick:()=>E(4),colorClass:"bg-pink-500"})]}),B.jsxs(ko,{title:"Vs Bot",subtitle:"Practice Mode",icon:"🤖",colorClass:"bg-teal-500",selected:p==="BOTS",onClick:()=>d("BOTS"),children:[B.jsx(fi,{label:"1 Bot",icon:"🤖",isSelected:b===1,onClick:()=>w(1),colorClass:"bg-teal-500"}),B.jsx(fi,{label:"2 Bots",icon:"🤖🤖",isSelected:b===2,onClick:()=>w(2),colorClass:"bg-teal-500"}),B.jsx(fi,{label:"3 Bots",icon:"🤖🤖🤖",isSelected:b===3,onClick:()=>w(3),colorClass:"bg-teal-500"})]})]})]})]}),B.jsx("div",{className:"pt-8 max-w-sm mx-auto animate-fade-in",children:B.jsx(An,{onClick:P,size:"lg",className:"w-full !text-xl !py-5 !rounded-3xl shadow-xl shadow-blue-500/20 !bg-blue-600 hover:!bg-blue-500",children:"Start Game"})})]})})]}):B.jsxs("div",{className:"flex flex-col h-screen w-full bg-slate-100 dark:bg-slate-900 overflow-hidden relative transition-colors duration-500",children:[B.jsxs("div",{className:"absolute inset-0 pointer-events-none opacity-40",children:[B.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-400/20 dark:bg-blue-900/20 rounded-full blur-[100px]"}),B.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-yellow-400/20 dark:bg-yellow-900/20 rounded-full blur-[100px]"})]}),B.jsxs("header",{className:"shrink-0 h-16 md:h-20 px-3 md:px-8 flex items-center justify-between z-30 bg-white/60 dark:bg-black/20 backdrop-blur-md border-b border-slate-200 dark:border-white/5 relative shadow-sm transition-colors duration-300",children:[B.jsx("div",{className:"flex-1 flex justify-start items-center min-w-0",children:B.jsxs("div",{className:"flex items-center gap-3",children:[B.jsx("div",{className:`
                        ...
                        `,children:r===W.ONE?"1":r===W.TWO?"2":r===W.THREE?"3":"4"}),B.jsxs("div",{className:"flex flex-col",children:[B.jsx("span",{className:"text-[10px] uppercase font-bold text-slate-400 leading-tight",children:"Current Turn"}),B.jsxs("span",{className:`text-base md:text-lg font-black ${O} leading-tight flex items-center gap-2`,children:[G?"Bot":_[r].name,G&&B.jsx("span",{className:"text-[10px] font-bold bg-slate-200 dark:bg-slate-700 px-1.5 py-0.5 rounded text-slate-500 uppercase",children:"Thinking"})]})]})]})}),B.jsxs("div",{className:"shrink-0 flex gap-2 mx-2",children:[B.jsx(An,{variant:"icon",size:"sm",onClick:M,title:"Back to Config",className:"w-9 h-9 md:w-11 md:h-11 p-2",children:B.jsx(bm,{})}),B.jsx(An,{variant:"icon",size:"sm",onClick:x,title:"Restart Game",className:"w-9 h-9 md:w-11 md:h-11 p-2",children:B.jsx(Tm,{})}),B.jsx(An,{variant:"icon",size:"sm",onClick:N,title:"Return to Menu",className:"w-9 h-9 md:w-11 md:h-11 p-2",children:B.jsx(Oo,{})})]}),B.jsx("div",{className:"flex-1"})]}),B.jsx("main",{className:"flex-1 w-full h-full flex flex-col items-center justify-center p-2 pb-10 relative z-10 perspective-1000 overflow-hidden",children:B.jsx("div",{className:`
                    relative aspect-square 
                    portrait:w-full portrait:max-h-full
                    landscape:h-full landscape:max-w-full
                    flex items-center justify-center
                `,children:B.jsx("div",{className:"w-full h-full flex items-center justify-center animate-fade-in relative",children:B.jsx(Wl,{})})})}),B.jsx("div",{className:"absolute inset-0 z-50 pointer-events-none",children:B.jsx(ym,{})}),i===Ot.WON&&B.jsx("div",{className:"fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in pointer-events-auto",children:B.jsxs("div",{className:"bg-white dark:bg-slate-800 p-8 rounded-[2rem] shadow-2xl max-w-sm w-full text-center border-4 border-blue-400 animate-bounce-in",children:[B.jsx("div",{className:"text-6xl mb-4 font-emoji",children:Be("🏆")}),B.jsxs("h2",{className:"text-3xl font-black text-slate-900 dark:text-white mb-2",children:[u.includes(s)?_[s].name:"Bot"," Wins!"]}),B.jsx("p",{className:"text-slate-500 dark:text-slate-400 font-medium mb-8",children:"A fantastic victory on the board!"}),B.jsxs("div",{className:"flex flex-col gap-3",children:[B.jsx(An,{onClick:x,size:"lg",className:"w-full !rounded-xl !py-4 shadow-lg !bg-blue-600 hover:!bg-blue-500",children:"Play Again"}),B.jsx(An,{onClick:M,variant:"secondary",className:"w-full !rounded-xl !py-4",children:"Back to Settings"})]})]})})]})};export{wm as LittleLudoGame};
